...
public class ContentsfromFile {
    ...
    public static void extractContent(final Parser parser, final String path)
    ...
    public static String extractContentForElastic(final Parser parser, final String path)
            throws IOException, SAXException, TikaException {
